...
public class NFeBuildAllCacerts {
	...
	public static void main(String[] args) {
		try {
		    ...
		    //info("|");
		    //info("| Certificados especificos...");
		    //setCertFromFile("C:/nfeJavaC/NF-e/Certs/CaixaV1/ICP-Brasil.cer", ks);
		    //setCertFromFile("C:/nfeJavaC/NF-e/Certs/CaixaV1/AC CAIXA v1.cer", ks);
		    //setCertFromFile("C:/nfeJavaC/NF-e/Certs/CaixaV1/AC CAIXA PJ v1.cer", ks);
	...
	public static void get(String host, int port, KeyStore ks) throws Exception {
	    try {
	    	...
	    	error("| " + host + ":" + port + " - " + e.toString());
		}
	}

	public static void setCertFromFile(String fileName, KeyStore ks) throws CertificateException, 
